...
#CUDA_VISIBLE_DEVICES='1' python train.py --dataset $dataset --data_path $data_path  --model_name 'ResNet18' --method 'our-SD' \
#	--epochs 200 --lr 0.1 --wd 0.0005 --batch_size 128 --eval_batch_size 256 --ema-decay 0.996 \
#	--KD_alpha 0.9 --KD_temperature 4.0 --loss_type 'KLS-MinEnt-Ft9' --reg_ft 1.0 \
...
CUDA_VISIBLE_DEVICES='3' python train_dyn.py --dataset $dataset --data_path $data_path  --model_name 'ResNet18' --method 'MES-v1' \
	--epochs 200 --lr 0.1 --wd 0.0005 --batch_size 128 --eval_batch_size 256 --ema-decay 0.5 \
	--KD_alpha 0.1 --KD_temperature 3.5 --loss_type 'KLS-MinEnt-Ft9' --reg_ft 1.0 \
       	--lmbda_adaptive 5  --Ti 200 --lmbda 5.0 --lmbda_min .05 --lmbda_dual 0.0 --budget_g 0.05 \
	--lmbda_dual_ent 0.0 --budget_g_ent 0.3 --lmbda_max_ent 1.0 --budget_g_ft 0.05 --budget_g_stable 0.05
