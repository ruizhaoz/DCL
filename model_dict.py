...
class OldResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        logits = out
        # return out
        return logits # feature of last layer (flattened), logits,
...
def EsbResNet18(num_classes=10, adaptive_pool=False):
    return OldResNet(BasicBlock, [2, 2, 2, 2], num_classes=num_classes, adaptive_pool=adaptive_pool)
...
def get_model_from_name( num_classes, name, dataset ):
    ...
    elif name == 'EsbResNet18':
        model = EsbResNet18( num_classes, adaptive_pool=adaptive_pool  )
    elif name == 'ResNet34':
