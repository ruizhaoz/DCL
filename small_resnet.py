...
def ResNet10_l(num_classes=100, adaptive_pool=False):
    return NewResNet(BasicBlock, [1, 1, 1, 1], num_classes=num_classes, all_planes=[32, 64, 128, 256],
                     adaptive_pool=adaptive_pool)


def ResNet10_m(num_classes=100, adaptive_pool=False):
    return NewResNet(BasicBlock, [1, 1, 1, 1], num_classes=num_classes, all_planes=[16, 32, 64, 128],
                     adaptive_pool=adaptive_pool)


def ResNet10_s2(num_classes=100, adaptive_pool=False):
    return NewResNet(BasicBlock, [1, 1, 1, 1], num_classes=num_classes, all_planes=[16, 16, 32, 64],
                     adaptive_pool=adaptive_pool)


def ResNet10_s(num_classes=100, adaptive_pool=False):
    return NewResNet(BasicBlock, [1, 1, 1, 1], num_classes=num_classes, all_planes=[8, 16, 32, 64],
                     adaptive_pool=adaptive_pool)


def ResNet10_xs(num_classes=100, adaptive_pool=False):
    return NewResNet(BasicBlock, [1, 1, 1, 1], num_classes=num_classes, all_planes=[8, 16, 16, 32],
                     adaptive_pool=adaptive_pool)


def ResNet10_xxs(num_classes=100, adaptive_pool=False):
    return NewResNet(BasicBlock, [1, 1, 1, 1], num_classes=num_classes, all_planes=[8, 8, 16, 16],
                     adaptive_pool=adaptive_pool)


def ResNet10_xxxs(num_classes=100, adaptive_pool=False):
    return NewResNet(BasicBlock, [1, 1, 1, 1], num_classes=num_classes, all_planes=[4, 8, 8, 16],
                     adaptive_pool=adaptive_pool)
...
def get_instant_weight_model(num_s_ft, num_t_ft, num_s_conv_ft=10, num_t_conv_ft=10, routing_name='default',
                             n_labels=10):
    if routing_name == 'b23_default':
        routingNet = B23_Inst_RoutingNetworkD(num_s_ft=num_s_ft, num_t_ft=num_t_ft, num_s_conv_ft=num_s_conv_ft,
                                              num_t_conv_ft=num_t_conv_ft, n_labels=n_labels)
    elif routing_name == 'b24_default':
        routingNet = B24_Inst_RoutingNetworkD(num_s_ft=num_s_ft, num_t_ft=num_t_ft, num_s_conv_ft=num_s_conv_ft,
                                              num_t_conv_ft=num_t_conv_ft, n_labels=n_labels)
    elif routing_name == 'b25_default':
        routingNet = B25_Inst_RoutingNetworkD(num_s_ft=num_s_ft, num_t_ft=num_t_ft, num_s_conv_ft=num_s_conv_ft,
                                              num_t_conv_ft=num_t_conv_ft, n_labels=n_labels)
    elif routing_name == 'b26_default':
        routingNet = B26_Inst_RoutingNetworkD(num_s_ft=num_s_ft, num_t_ft=num_t_ft, num_s_conv_ft=num_s_conv_ft,
                                              num_t_conv_ft=num_t_conv_ft, n_labels=n_labels)
    else:
        assert (1 == 2)
